...
async function main() {
    ...
    deployedAddresses.FamilyRegistry = familyRegistry.address;
    ...
    // 4. 部署 RewardRegistry (使用已部署的 RewardToken 地址)
    ...
    // 5. 设置 RewardRegistry 为 RewardToken 的授权铸造者
